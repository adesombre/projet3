...
class Display:
    ...
    def load_assets(self):
        self.assets["wall"] = pygame.image.load \
            ('ressource/mur.png').convert_alpha()
        self.assets["background"] = pygame.image.load \
            ('ressource/fond.jpg').convert_alpha()
        self.assets["mc_gyver"] = pygame.image.load \
            ('ressource/macGyver.png').convert_alpha()
        self.assets["guardian"] = pygame.image.load \
            ('ressource/Gardien.png').convert_alpha()
        self.assets["needle"] = pygame.image.load \
            ('ressource/aiguille.png').convert_alpha()
        self.assets["syringe"] = pygame.image.load \
            ('ressource/seringue.png').convert_alpha()
        self.assets["bottle_ether"] = pygame.image.load \
